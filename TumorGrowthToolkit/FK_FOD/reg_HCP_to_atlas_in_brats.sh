...
# antsRegistrationSyN.sh -t s -f ${regged_old_atlas_dir}/${subj_id}/transformed_t1.nii.gz -m ${subj_out}/data_rig_shell0000.nii.gz -o ${subj_out}/data_rig_SyN_shell0000 -n 15

#antsRegistrationSyN.sh -t s -f ${regged_old_atlas_dir}/${subj_id}/transformed_t1.nii.gz -m ${subj_out}/T1w_masked_rig.nii.gz -o ${subj_out}/data_rig_SyN_shell0000 -n 15
